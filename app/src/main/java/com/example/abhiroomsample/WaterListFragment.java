 ...
 * {@link WaterListFragment.OnListFragmentInteractionListener} interface
...
public class WaterListFragment extends Fragment {
    ...
    private List<Water> whooshList = new ArrayList<Water>();

    WaterListAdapter adapter;
    ...
    public interface OnListFragmentInteractionListener {
        ...
        List<Water> newSearch(String date, String time);
    }
}
